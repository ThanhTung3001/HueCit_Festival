...
class HuenewsItemWidget extends StatelessWidget {
  HuenewsItemWidget(this.huenewsItemModelObj);

  HuenewsItemModel huenewsItemModelObj;

  var controller = Get.find<HuenewsController>();
